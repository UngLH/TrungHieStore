            ...
            <div class="col-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="" method="POST" enctype="application/x-www-form-urlencoded" action="momo.php">
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class='input-group date' id='fxRate'>
                                            <input type='text' name="paymentCode" value="<?php echo $paymentCode; ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
